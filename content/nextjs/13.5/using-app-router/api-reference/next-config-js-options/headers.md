...
- `has` is an array of [has objects](/nextjs/13.5/using-app-router/api-reference/next-config-js-options/headers#header-cookie-and-query-matching) with the `type`, `key` and `value` properties.
- `missing` is an array of [missing objects](/nextjs/13.5/using-app-router/api-reference/next-config-js-options/headers#header-cookie-and-query-matching) with the `type`, `key` and `value` properties.
...
Learn more about [caching](/nextjs/13.5/using-app-router/building-your-application/caching) with the App Router.
