...
> - If your project uses [Image Optimization](/nextjs/13.5/using-app-router/building-your-application/optimizing/images) with the default `loader`, you must install `sharp` as a dependency:
> 
