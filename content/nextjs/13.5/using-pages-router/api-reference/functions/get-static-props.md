...
If the redirects are known at build-time, they should be added in [`next.config.js`](/nextjs/13.5/using-pages-router/api-reference/next-config-js-options/redirects) instead.
