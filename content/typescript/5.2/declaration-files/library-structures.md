...
[`module.d.ts`](/typescript/5.2/declaration-files/d-ts-templates/modules-d-ts), [`module-class.d.ts`](/typescript/5.2/declaration-files/d-ts-templates/module-class), [`module-function.d.ts`](/typescript/5.2/declaration-files/d-ts-templates/module-function) and [`module-plugin.d.ts`](/typescript/5.2/declaration-files/d-ts-templates/module-plugin).

You should first read [`module.d.ts`](/typescript/5.2/declaration-files/d-ts-templates/modules-d-ts) for an overview on the way they all work.

Then use the template [`module-function.d.ts`](/typescript/5.2/declaration-files/d-ts-templates/module-function) if your module can be *called* like a function:
...
Use the template [`module-class.d.ts`](/typescript/5.2/declaration-files/d-ts-templates/module-class) if your module can be *constructed* using `new`:
...
If you have a module which when imported, makes changes to other modules use template [`module-plugin.d.ts`](/typescript/5.2/declaration-files/d-ts-templates/module-plugin):
...
Use the [`module-plugin.d.ts`](/typescript/5.2/declaration-files/d-ts-templates/module-plugin) template.
