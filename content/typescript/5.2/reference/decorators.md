...
If we were to use [decorator factories](/typescript/5.2/reference/decorators#decorator-factories), we can observe this evaluation order with the following example:
...
The `@enumerable(false)` decorator here is a [decorator factory](/typescript/5.2/reference/decorators#decorator-factories).
...
The `@format("Hello, %s")` decorator here is a [decorator factory](/typescript/5.2/reference/decorators#decorator-factories).
...
> See [Metadata](/typescript/5.2/reference/decorators#metadata) for more information about the `reflect-metadata` library.
> 
