...
Be aware, however, that object literals [may only specify known properties](/typescript/5.2/handbook/objects#excess-property-checks).
...
Reiterating [The Basics](/typescript/5.2/handbook/basic-types):
