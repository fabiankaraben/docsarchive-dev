...
Numeric enums can be mixed in [computed and constant members (see below)](/typescript/5.2/reference/enums#computed-and-constant-members).
...
String enums are a similar concept, but have some subtle [runtime differences](/typescript/5.2/reference/enums#enums-at-runtime) as documented below.
...
In other words, if you were debugging and had to read the runtime value of a numeric enum, the value is often opaque - it doesn’t convey any useful meaning on its own (though [reverse mapping](/typescript/5.2/reference/enums#reverse-mappings) can often help). String enums allow you to give a meaningful and readable value when your code runs, independent of the name of the enum member itself.
