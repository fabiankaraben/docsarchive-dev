...
> Released:
> [4.5](/typescript/5.2/whats-new/typescript-4-5#the-awaited-type-and-promise-improvements)
> 
...
> Released:[2.1](/typescript/5.2/whats-new/typescript-2-1#partial-readonly-record-and-pick)
> 
...
> Released:[2.8](/typescript/5.2/whats-new/typescript-2-8#improved-control-over-mapped-type-modifiers)
> 

Constructs a type consisting of all properties of `Type` set to required. The opposite of [`Partial`](/typescript/5.2/reference/utility-types#partialtype).
...
> Released:[3.5](/typescript/5.2/whats-new/typescript-3-5#the-omit-helper-type)
> 

Constructs a type by picking all properties from `Type` and then removing `Keys` (string literal or union of string literals). The opposite of [`Pick`](/typescript/5.2/reference/utility-types#picktype-keys).
...
> Released:[2.8](/typescript/5.2/whats-new/typescript-2-8#predefined-conditional-types)
> 
...
For overloaded functions, this will be the parameters of the *last* signature; see [Inferring Within Conditional Types](/typescript/5.2/handbook/type-manipulation/conditional-types#inferring-within-conditional-types).
...
For overloaded functions, this will be the return type of the *last* signature; see [Inferring Within Conditional Types](/typescript/5.2/handbook/type-manipulation/conditional-types#inferring-within-conditional-types).
...
Extracts the type of the [this ↗](https://www.typescriptlang.org/docs/handbook/functions.html#this-parameters) parameter for a function type, or [unknown](/typescript/5.2/whats-new/typescript-3-0#new-unknown-top-type) if the function type has no `this` parameter.
...
To help with string manipulation around template string literals, TypeScript includes a set of types which can be used in string manipulation within the type system. You can find those in the [Template Literal Types](/typescript/5.2/handbook/type-manipulation/template-literal-types#uppercasestringtype) documentation.
