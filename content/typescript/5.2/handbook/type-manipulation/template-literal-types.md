...
Template literal types build on [string literal types](/typescript/5.2/handbook/everyday-types#literal-types), and have the ability to expand into many strings via unions.
