...
**If you’re looking for more information about the compiler options in a tsconfig, check out the [TSConfig Reference ↗](https://www.typescriptlang.org/tsconfig.html)**
...
|`[--allowSyntheticDefaultImports ↗](https://www.typescriptlang.org/tsconfig.html#allowSyntheticDefaultImports)`|`boolean`<br>|`true` if [`esModuleInterop`](/typescript/5.2/project-configuration/compiler-options#esModuleInterop) is enabled, [`module`](/typescript/5.2/project-configuration/compiler-options#module) is `system`, or [`moduleResolution`](/typescript/5.2/project-configuration/compiler-options#module-resolution) is `bundler`; `false` otherwise.<br>|
...
|`[--alwaysStrict ↗](https://www.typescriptlang.org/tsconfig.html#alwaysStrict)`|`boolean`<br>|`true` if [`strict`](/typescript/5.2/project-configuration/compiler-options#strict); `false` otherwise.<br>|
...
|Have recompiles in projects that use [`incremental`](/typescript/5.2/project-configuration/compiler-options#incremental) and `watch` mode assume that changes within a file will only affect files directly depending on it.<br>|
...
|`[--declaration ↗](https://www.typescriptlang.org/tsconfig.html#declaration)`|`boolean`<br>|`true` if [`composite`](/typescript/5.2/project-configuration/compiler-options#composite); `false` otherwise.<br>|
...
|`[--esModuleInterop ↗](https://www.typescriptlang.org/tsconfig.html#esModuleInterop)`|`boolean`<br>|`true` if [`module`](/typescript/5.2/project-configuration/compiler-options#module) is `node16` or `nodenext`; `false` otherwise.<br>|
|Emit additional JavaScript to ease support for importing CommonJS modules. This enables [`allowSyntheticDefaultImports`](/typescript/5.2/project-configuration/compiler-options#allowSyntheticDefaultImports) for type compatibility.<br>|
...
|`[--incremental ↗](https://www.typescriptlang.org/tsconfig.html#incremental)`|`boolean`<br>|`true` if [`composite`](/typescript/5.2/project-configuration/compiler-options#composite); `false` otherwise.<br>|
...
|Specify the maximum folder depth used for checking JavaScript files from `node_modules`. Only applicable with [`allowJs`](/typescript/5.2/project-configuration/compiler-options#allowJs).<br>|
|`[--module ↗](https://www.typescriptlang.org/tsconfig.html#module)`|`none`, `commonjs`, `amd`, `umd`, `system`, `es6`/`es2015`, `es2020`, `es2022`, `esnext`, `node16`, or `nodenext`<br>|`CommonJS` if [`target`](/typescript/5.2/project-configuration/compiler-options#target) is `ES3` or `ES5`; `ES6`/`ES2015` otherwise.<br>|
...
|`[--moduleResolution ↗](https://www.typescriptlang.org/tsconfig.html#moduleResolution)`|`classic`, `node10`/`node`, `node16`, `nodenext`, or `bundler`<br>|`Classic` if [`module`](/typescript/5.2/project-configuration/compiler-options#module) is `AMD`, `UMD`, `System`, or `ES6`/`ES2015`; Matches if [`module`](/typescript/5.2/project-configuration/compiler-options#module) is `node16` or `nodenext`; `Node` otherwise.<br>|
...
|`[--noImplicitAny ↗](https://www.typescriptlang.org/tsconfig.html#noImplicitAny)`|`boolean`<br>|`true` if [`strict`](/typescript/5.2/project-configuration/compiler-options#strict); `false` otherwise.<br>|
...
|`[--noImplicitThis ↗](https://www.typescriptlang.org/tsconfig.html#noImplicitThis)`|`boolean`<br>|`true` if [`strict`](/typescript/5.2/project-configuration/compiler-options#strict); `false` otherwise.<br>|
...
|Deprecated setting. Use [`outFile`](/typescript/5.2/project-configuration/compiler-options#outFile) instead.<br>|
...
|Specify a file that bundles all outputs into one JavaScript file. If [`declaration`](/typescript/5.2/project-configuration/compiler-options#declaration) is true, also designates a file that bundles all .d.ts output.<br>|
...
|`[--preserveConstEnums ↗](https://www.typescriptlang.org/tsconfig.html#preserveConstEnums)`|`boolean`<br>|`true` if [`isolatedModules`](/typescript/5.2/project-configuration/compiler-options#isolatedModules); `false` otherwise.<br>|
...
|`[--resolvePackageJsonExports ↗](https://www.typescriptlang.org/tsconfig.html#resolvePackageJsonExports)`|`boolean`<br>|`true` when [`moduleResolution`](/typescript/5.2/project-configuration/compiler-options#moduleResolution) is `node16`, `nodenext`, or `bundler`; otherwise `false`<br>|
|Use the package.json 'exports' field when resolving package imports.<br>|
|`[--resolvePackageJsonImports ↗](https://www.typescriptlang.org/tsconfig.html#resolvePackageJsonImports)`|`boolean`<br>|`true` when [`moduleResolution`](/typescript/5.2/project-configuration/compiler-options#moduleResolution) is `node16`, `nodenext`, or `bundler`; otherwise `false`<br>|
...
|`[--strictBindCallApply ↗](https://www.typescriptlang.org/tsconfig.html#strictBindCallApply)`|`boolean`<br>|`true` if [`strict`](/typescript/5.2/project-configuration/compiler-options#strict); `false` otherwise.<br>|
|Check that the arguments for `bind`, `call`, and `apply` methods match the original function.<br>|
|`[--strictFunctionTypes ↗](https://www.typescriptlang.org/tsconfig.html#strictFunctionTypes)`|`boolean`<br>|`true` if [`strict`](/typescript/5.2/project-configuration/compiler-options#strict); `false` otherwise.<br>|
|When assigning functions, check to ensure parameters and the return values are subtype-compatible.<br>|
|`[--strictNullChecks ↗](https://www.typescriptlang.org/tsconfig.html#strictNullChecks)`|`boolean`<br>|`true` if [`strict`](/typescript/5.2/project-configuration/compiler-options#strict); `false` otherwise.<br>|
|When type checking, take into account `null` and `undefined`.<br>|
|`[--strictPropertyInitialization ↗](https://www.typescriptlang.org/tsconfig.html#strictPropertyInitialization)`|`boolean`<br>|`true` if [`strict`](/typescript/5.2/project-configuration/compiler-options#strict); `false` otherwise.<br>|
...
|Suppress [`noImplicitAny`](/typescript/5.2/project-configuration/compiler-options#noImplicitAny) errors when indexing objects that lack index signatures.<br>|
...
|Log paths used during the [`moduleResolution`](/typescript/5.2/project-configuration/compiler-options#moduleResolution) process.<br>|
...
|`[--useDefineForClassFields ↗](https://www.typescriptlang.org/tsconfig.html#useDefineForClassFields)`|`boolean`<br>|`true` if [`target`](/typescript/5.2/project-configuration/compiler-options#target) is `ES2022` or higher, including `ESNext`; `false` otherwise.<br>|
|Emit ECMAScript-standard-compliant class fields.<br>|
|`[--useUnknownInCatchVariables ↗](https://www.typescriptlang.org/tsconfig.html#useUnknownInCatchVariables)`|`boolean`<br>|`true` if [`strict`](/typescript/5.2/project-configuration/compiler-options#strict); `false` otherwise.<br>|
