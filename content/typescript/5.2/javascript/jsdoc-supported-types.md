...
> Note: Error messages only show up in JS codebases with [a JSConfig](/typescript/5.2/project-configuration/tsconfig-json) and [`checkJs` ↗](https://www.typescriptlang.org/tsconfig.html#checkJs) enabled.
> 
