...
weight: 4
type: docs
canonical: /typescript/5.2/handbook/narrowing
---
...
In addition, classes can [use `this is Type`](/typescript/5.1/handbook/classes#this-based-type-guards) to narrow their type.

## Assertion functions {#assertion-functions}

Types can also be narrowed using [Assertion functions](/typescript/5.1/whats-new/typescript-3-7#assertion-functions).
