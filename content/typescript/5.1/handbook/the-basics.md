...
The [`strict` ↗](https://www.typescriptlang.org/tsconfig.html#strict) flag in the CLI, or `"strict": true` in a [`tsconfig.json`](/typescript/5.1/project-configuration/what-is-a-tsconfig-json) toggles them all on simultaneously, but we can opt out of them individually.
