...
We have cheat-sheets available for both [`type` and `interface`](/typescript/5.1/reference/cheatsheets), if you want a quick look at the important every-day syntax at a glance.
