...
See [Module: Functions](/typescript/5.1/declaration-files/d-ts-templates/module-function) for details of how that works, and the [Modules reference](/typescript/5.1/reference/modules) page.
...
To understand how namespaces work in `.d.ts` files read the [`.d.ts` deep dive](/typescript/5.1/declaration-files/deep-dive).
