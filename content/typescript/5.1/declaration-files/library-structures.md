...
As with global modules, you might see these examples in the documentation of [a UMD](/typescript/5.1/declaration-files/library-structures#umd) module, so be sure to check the code or documentation.
...
Be sure to read the [“Preventing Name Conflicts” footnote](/typescript/5.1/declaration-files/library-structures#preventing-name-conflicts).
