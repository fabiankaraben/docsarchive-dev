...
You can use most JSDoc type syntax and any TypeScript syntax, from [the most basic like `string`](/typescript/5.1/handbook/the-basics) to [the most advanced, like conditional types](/typescript/5.1/handbook/type-manipulation/conditional-types).
...
> Note: Error messages only show up in JS codebases with [a JSConfig](/typescript/5.1/project-configuration/what-is-a-tsconfig-json) and [`checkJs` ↗](https://www.typescriptlang.org/tsconfig.html#checkJs) enabled.
> 
