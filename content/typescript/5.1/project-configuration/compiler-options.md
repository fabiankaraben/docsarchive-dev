...
**If you’re looking for more information about the compiler options in a tsconfig, check out the [TSConfig Reference](/typescript/5.1/project-configuration/tsconfig)**
...
- Every option is fully explained in the [TSConfig Reference](/typescript/5.1/project-configuration/tsconfig).
