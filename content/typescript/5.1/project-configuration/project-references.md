...
With more `tsconfig.json` files, you’ll usually want to use [Configuration file inheritance](/typescript/5.1/project-configuration/what-is-a-tsconfig-json) to centralize your common compiler options.
