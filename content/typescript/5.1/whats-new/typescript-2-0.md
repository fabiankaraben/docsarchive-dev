...
Files included using [`include` ↗](https://www.typescriptlang.org/tsconfig.html#include) can be filtered using the [`exclude` ↗](https://www.typescriptlang.org/tsconfig.html#exclude) property.
