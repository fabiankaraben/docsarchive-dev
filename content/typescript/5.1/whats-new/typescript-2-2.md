...
## Support for `new.target` {#support-for-newtarget}
...
## Better checking for `null`/`undefined` in operands of expressions {#better-checking-for-nullundefined-in-operands-of-expressions}
