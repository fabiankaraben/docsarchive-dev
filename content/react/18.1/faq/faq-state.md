...
[`props`](/react/18.1/main-concepts/components-and-props) (short for “properties”) and [`state`](/react/18.1/main-concepts/state-and-lifecycle) are both plain JavaScript objects. While both hold information that influences the output of render, they are different in one important way: `props` get passed *to* the component (similar to function parameters) whereas `state` is managed *within* the component (similar to variables declared within a function).
...
[Learn more about setState ↗](https://reactjs.org/docs/react-component.html#setstate)
