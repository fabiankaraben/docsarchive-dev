...
In these cases we should rather use [React Fragments](/react/18.1/advanced-guides/fragments) to group together multiple elements.
...
When you don’t need any props on the Fragment tag you can use the [short syntax](/react/18.1/advanced-guides/fragments#short-syntax), if your tooling supports it:
...
For more info, see [the Fragments documentation](/react/18.1/advanced-guides/fragments).
...
[![Blue keyboard focus outline around a selected link.](/assets/react/18.1/static/dec0e6bcc1f882baf76ebc860d4f04e5/4fcfe/keyboard-focus.png)](/static/dec0e6bcc1f882baf76ebc860d4f04e5/4fcfe/keyboard-focus.png)
...
![A toggle button opening a popover list implemented with the click outside pattern and operated with a mouse showing that the close action works.](/assets/react/18.1/5523b05b22210c5a2fa0bd1f01339cb3/outerclick-with-mouse.gif)
...
![A toggle button opening a popover list implemented with the click outside pattern and operated with the keyboard showing the popover not being closed on blur and it obscuring other screen elements.](/assets/react/18.1/eca0ca825c8c5e2aa609cee72ef47e27/outerclick-with-keyboard.gif)
...
![A popover list correctly closing for both mouse and keyboard users.](/assets/react/18.1/28ce2067489843caf05fe7ce22494542/blur-popover-close.gif)
