---
linkTitle: "Add React to a Website"
...
- [Add React in One Minute](/react/18.1/installation/add-react-to-a-website#add-react-in-one-minute)
- [Optional: Try React with JSX](/react/18.1/installation/add-react-to-a-website#optional-try-react-with-jsx) (no bundler necessary!)
...
> Tip
> This code defines a React component called `LikeButton`. Don’t worry if you don’t understand it yet — we’ll cover the building blocks of React later in our [hands-on tutorial ↗](https://reactjs.org/tutorial/tutorial.html) and [main concepts guide](/react/18.1/main-concepts/hello-world). For now, let’s just get it showing on the screen!
> 
...
> Note
> This strategy is mostly useful while React-powered parts of the page are isolated from each other. Inside React code, it’s easier to use [component composition](/react/18.1/main-concepts/components-and-props#composing-components) instead.
> 
...
However, React also offers an option to use [JSX](/react/18.1/main-concepts/introducing-jsx) instead:
...
These two code snippets are equivalent. While **JSX is [completely optional](/react/18.1/advanced-guides/react-without-jsx)**, many people find it helpful for writing UI code — both with React and with other libraries.
...
> If you see an error message saying “You have mistakenly installed the `babel` package”, you might have missed [the previous step](/react/18.1/installation/add-react-to-a-website#add-jsx-to-a-project). Perform it in the same folder, and then try again.
> 
...
If you notice that you’re getting comfortable with build tools and want them to do more for you, [the next section](/react/18.1/installation/create-a-new-react-app) describes some of the most popular and approachable toolchains. If not — those script tags will do just fine!
