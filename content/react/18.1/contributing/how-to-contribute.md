...
weight: 1
type: docs
prev: /react/18.1/testing/testing-environments
---
...
React follows [semantic versioning ↗](https://semver.org/). We release patch versions for critical bugfixes, minor versions for new features or non-essential changes, and major versions for any breaking changes. When we make breaking changes, we also introduce deprecation warnings in a minor version so that our users learn about the upcoming changes and migrate their code in advance. Learn more about our commitment to stability and incremental migration in [our versioning policy](/react/18.1/faq/faq-versioning).
...
Read the [next section](/react/18.1/contributing/codebase-overview) to learn how the codebase is organized.
