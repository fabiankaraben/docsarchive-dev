...
Here, `e` is a synthetic event. React defines these synthetic events according to the [W3C spec ↗](https://www.w3.org/TR/DOM-Level-3-Events/), so you don’t need to worry about cross-browser compatibility. React events do not work exactly the same as native events. See the [`SyntheticEvent`](/react/18.1/api-reference/events) reference guide to learn more.
